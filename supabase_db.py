...
def guardar_aporte_socio(socio, tipo, fecha, monto, concepto, caja_id, cuotas=None, aporte_id=None, tasa=None):
    client = get_client()
...
def actualizar_aporte_socio(id, socio, tipo, fecha, monto, concepto, caja_id, cuotas=None, aporte_id=None, tasa=None):
    client = get_client()
